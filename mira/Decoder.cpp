...
namespace Mira {
  ...
  **/
  ...
  MosesDecoder::MosesDecoder(bool scaleByInputLength, bool scaleByTargetLength, float historySmoothing)
		: m_manager(NULL) {
      ...
      m_bleuScoreFeature = new BleuScoreFeature(scaleByInputLength, scaleByTargetLength, historySmoothing);
