...
protected:
	...
	std::vector< std::vector< TranslationOptionList > >	m_unaryCollection; /*< contains translation options */
...
public:
	...
	TranslationOptionList &GetUnaryTranslationOptionList(const Moses::WordsRange &range);
	const TranslationOptionList &GetUnaryTranslationOptionList(const Moses::WordsRange &range) const;

	void CreateUnaryTranslationOptionsForRange(size_t startPos
																						 , size_t endPos);
