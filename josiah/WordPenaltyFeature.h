...
class WordPenaltyFeature : public Feature {
  public:
    virtual FeatureFunctionHandle getFunction(const Sample& sample) const;
};


class WordPenaltyFeatureFunction : public SingleValuedFeatureFunction {
  public:
    
    WordPenaltyFeatureFunction(const Sample& sample);
...
protected:
    ...
    virtual FValue getContiguousPairedUpdateScore(const Moses::TranslationOption* leftOption,const Moses::TranslationOption* rightOption, 
       const TargetGap& gap);
    virtual FValue getDiscontiguousPairedUpdateScore(const Moses::TranslationOption* leftOption,
...
class UnknownWordPenaltyFeature : public Feature {
  public:
    virtual FeatureFunctionHandle getFunction(const Sample& sample) const;
};


class UnknownWordPenaltyFeatureFunction : public SingleValuedFeatureFunction {

  public:
    
    UnknownWordPenaltyFeatureFunction(const Sample& sample);
