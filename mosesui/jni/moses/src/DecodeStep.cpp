// $Id: DecodeStep.cpp 3394 2010-08-10 13:12:00Z bhaddow $
...
{
  return (const PhraseDictionaryFeature*) (m_decodeFeature);
}
...
{
  return (const GenerationDictionary*)(m_decodeFeature);
}
