...
my($_ROOT_DIR, $_CORPUS_DIR, $_GIZA_E2F, $_GIZA_F2E, $_MODEL_DIR, $_CORPUS,
...
$_ALIGNMENT_FILE, @_LM, $_EXTRACT_FILE, $_GIZA_OPTION, $_HELP, $_PARTS,
...
@_REORDERING_TABLE, @_GENERATION_TABLE, $_CONFIG, $_DONT_ZIP, $_HMM_ALIGN,
@_GENERATION_TYPE);
