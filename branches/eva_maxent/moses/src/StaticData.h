// $Id: StaticData.h 1902 2008-10-14 19:25:18Z hieuhoang1972 $
...
protected:	
	...
	std::vector<LexicalReordering*>                   m_lexReorderModels;
	std::vector<MaxentReordering*>                   m_maxentReorderModels;
	...
	bool LoadMaxentReorderingModel();
...
public:
	...
	const std::vector<LexicalReordering*> &GetLexicalReorderModels() const
	{
		return m_lexReorderModels;
	}
	const std::vector<MaxentReordering*> &GetMaxentReorderModels() const
	{
		return m_maxentReorderModels;
	}
