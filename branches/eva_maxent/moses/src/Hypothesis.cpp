// $Id: Hypothesis.cpp 1897 2008-10-08 23:51:26Z hieuhoang1972 $
// vim:tabstop=2
/***********************************************************************
...
void Hypothesis::CalcScore(const SquareMatrix &futureScore) 
{
	...
	const std::vector<LexicalReordering*> &lexReorderModels = staticData.GetLexicalReorderModels();
	for(unsigned int i = 0; i < lexReorderModels.size(); i++)
	{
...
const ScoreComponentCollection &Hypothesis::GetCachedLexicalReorderingScore() const
{
	return m_transOpt->GetLexicalReorderingScore();
}
