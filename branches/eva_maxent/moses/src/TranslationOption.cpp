// $Id: TranslationOption.cpp 1897 2008-10-08 23:51:26Z hieuhoang1972 $
// vim:tabstop=2
...
, m_lexReordering(copy.m_lexReordering)
, m_maxentReordering(copy.m_maxentReordering)
{}
...
void TranslationOption::CacheLexicalReorderingProb(const LexicalReordering &lexreordering
												, const Score &score)
{
	m_lexReordering.Assign(&lexreordering, score);
}

void TranslationOption::CacheMaxentReorderingProb(const MaxentReordering &maxentreordering
												, const Score &score)
{
	m_maxentReordering.Assign(&maxentreordering, score);
}
