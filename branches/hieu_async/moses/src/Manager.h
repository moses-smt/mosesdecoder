// $Id: Manager.h 189 2007-11-09 17:06:31Z hieu $
...
protected:	
	...
	HypothesisStackCollection m_hypoStackColl; /**< vector of stacks to store hypothesis (partial translations) */ 
	...
	void ExpandHypothesis(const Hypothesis &hypothesis
												, const TranslationOption &transOpt
												, size_t distFromDiagonal);
	
	void RemoveDeadendHypotheses(size_t stackNo, const Hypothesis *excludeHypo = NULL);
