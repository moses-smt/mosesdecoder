// $Id: FactorMask.cpp 148 2007-10-15 15:36:18Z hieu $
...
void FactorMask::Merge(const FactorMask &other)
{
	operator|=(other);
}

FactorMask FactorMask::GetIntersection(const FactorMask &other) const
{
	return (*this) & other;
}
