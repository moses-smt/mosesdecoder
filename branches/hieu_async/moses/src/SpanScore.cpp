// $Id: SpanScore.cpp 92 2007-09-13 21:22:57Z hieu $
...
void SpanScore::Initialize(const DecodeStepCollection &decodeStepList)
{
	m_matrices.resize(decodeStepList.GetSize());
