// $Id: LanguageModelSkip.h 87 2007-09-10 23:17:43Z hieu $
...
public:
	...
	*/
	LanguageModelSkip(LanguageModelSingleFactor *lmImpl, bool registerScore, ScoreIndexManager &scoreIndexManager)
