// $Id: TranslationOption.h 172 2007-10-31 18:12:33Z hieu $
...
public:
	...
	TranslationOption(const WordsRange &wordsRange, const TargetPhrase &targetPhrase, size_t decodeStepId);
	/** constructor. Used to create trans opt from unknown word */
	TranslationOption(const WordsRange &wordsRange, const TargetPhrase &targetPhrase, size_t decodeStepId, int);
