// $Id: Parameter.cpp 151 2007-10-16 12:21:29Z hieu $
...
Parameter::Parameter() 
{
	...
	AddParam("distortion-limit", "dl", "distortion (reordering) limit in maximum number of words. -1=unlimited distortion. 0=NO distortion");	
	...
	AddParam("async-method", "which method to go thru stacks? 0=upper triangle, 1=complete each decode step 1st. 2=upper diagonal, contrained by (need 2nd param). Default is 2");
