// $Id: LanguageModelIRST.h 87 2007-09-10 23:17:43Z hieu $
...
public:
  ...
  virtual float GetValue(const std::vector<Word> &contextFactor, State* finalState = NULL, unsigned int* len=0) const;
