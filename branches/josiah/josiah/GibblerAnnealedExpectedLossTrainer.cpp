...
float GibblerAnnealedExpectedLossCollector::UpdateGradient(ScoreComponentCollection* gradient, float* exp_len, float *unreg_exp_gain, float *scaling_gradient) {
  ...
  return ExpectedLossCollector::UpdateGradient(gradient,exp_len, unreg_exp_gain, scaling_gradient);
}
