// $Id: PhraseDictionaryNodeSourceLabel.h 2088 2009-02-06 15:54:48Z hieuhoang1972 $
// vim:tabstop=2
...
*/
class PhraseDictionaryNodeSourceLabel : public PhraseDictionaryNode
{
	friend std::ostream& operator<<(std::ostream&, const PhraseDictionaryNodeSourceLabel&);
	
	typedef std::map<Word, PhraseDictionaryNodeSourceLabel> InnerNodeMap;
	...
	friend class std::map<Word, PhraseDictionaryNodeSourceLabel>;
...
public:
	...
	PhraseDictionaryNodeSourceLabel *GetOrCreateChild(const Word &word, const Word &sourcelabel);
	const PhraseDictionaryNodeSourceLabel *GetChild(const Word &word, const Word &sourcelabel) const;
