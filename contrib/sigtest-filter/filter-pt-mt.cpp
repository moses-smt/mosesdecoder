...
static boost::thread_specific_ptr<PhraseSetMap> fsets;
...
int main(int argc, char * argv[])
{
  ...
  // Load file paths for all phrase table parts
  std::vector<std::string> splitInPaths;
