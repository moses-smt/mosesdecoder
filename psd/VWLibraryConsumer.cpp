...
const char * VW_INIT_OPTIONS = "--hash all --noconstant -q st -t --ldf_override sc";
//const char * VW_INIT_OPTIONS = "-t --hash all --noconstant -b 30 -q st --csoaa_ldf s"; //old options
