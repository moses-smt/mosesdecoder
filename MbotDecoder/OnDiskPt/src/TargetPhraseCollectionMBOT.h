// $Id: TargetPhraseCollectionMBOT.h,v 1.1.1.1 2013/01/06 16:54:14 braunefe Exp $
/***********************************************************************
...
namespace Moses
{
class TargetPhraseCollectionMBOT;
...
public:
  ...
  TargetPhraseCollectionMBOT();
  TargetPhraseCollectionMBOT(const TargetPhraseCollectionMBOT &copy);
  ...
  Moses::TargetPhraseCollectionMBOT *ConvertToMoses(const std::vector<Moses::FactorType> &inputFactors
