// $Id: ChartHypothesis.h,v 1.1.1.1 2013/01/06 16:54:18 braunefe Exp $
// vim:tabstop=2
/***********************************************************************
...
public:
 ...
 virtual ~ChartHypothesis();
  ...
  virtual const ChartTranslationOption &GetTranslationOption()const {
    return m_transOpt;
  }
  virtual const TargetPhrase &GetCurrTargetPhrase()const {
