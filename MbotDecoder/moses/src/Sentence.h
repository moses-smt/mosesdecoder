// $Id: Sentence.h,v 1.1.1.1 2013/01/06 16:54:16 braunefe Exp $
...
public:
  ...
  //Fabienne Braune : we need a mutable label set
  NonTerminalSet GetMutableLabelSet(size_t /*startPos*/, size_t /*endPos*/) const {
	    return m_defaultLabelSet;
	  }
