// $Id: Parameter.cpp,v 1.1.1.1 2013/01/06 16:54:17 braunefe Exp $
...
Parameter::Parameter()
{
  ...
  //Match source syntactic labels during rule application or not
  AddParam("source-label-matching-at-rule-application", "SMARA", "match source syntactic labels during rule application");

  //Fabienne Braune : if this option is on, then the decoder matches all possible source labels
  //and not the labels in the parse tree
