// $Id: Implementation.h,v 1.2 2013/01/14 19:56:00 braunefe Exp $
...
class LanguageModelImplementation
{
  ...
  void ShiftOrPushMBOT(std::vector< std::vector<const Word*> > &contextFactor, const size_t currentMBOT, const Word &word, std::vector<Word*> copies) const;
...
class LMRefCount : public LanguageModel {
  public:
    ...
    //BEWARE: added evaluate for MBOT language model
