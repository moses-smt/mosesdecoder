// $Id: Word.cpp,v 1.1.1.1 2013/01/06 16:54:17 braunefe Exp $
// vim::tabstop=2
                            ...
                            , bool isNonTerminal)
{
  ...
  //std::cout << "size of wordVec " << wordVec.size() << std::endl;
  // std::cout << "size of factorOrder " << factorOrder.size() << std::endl;
