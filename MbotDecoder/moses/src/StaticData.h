// $Id: StaticData.h,v 1.1.1.1 2013/01/06 16:54:17 braunefe Exp $
...
protected:
  ...
  //Fabienne Braune : vector of string containing the source side labels
  ...
  //! mbot decoder : determines if source labels have to be matched at rule application
