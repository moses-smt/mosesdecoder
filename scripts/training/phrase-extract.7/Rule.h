...
protected:
	...
	void CreateSymbols(bool &isValid, const SentenceAlignment &sentence);
...
public:
	...
	Rule(bool &isValid, const Rule &copy, const LatticeNode *lhs, const SentenceAlignment &sentence);
