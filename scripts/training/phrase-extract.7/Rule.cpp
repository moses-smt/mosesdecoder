...
Rule::Rule(bool &isValid, const Rule &copy, const LatticeNode *lhs, const SentenceAlignment &sentence)
:m_coll(copy.m_coll)
,m_source(copy.m_source)
,m_target(copy.m_target)
,m_lhs(lhs)
{	
	CreateSymbols(isValid, sentence);
}
...
void Rule::CreateSymbols(bool &isValid, const SentenceAlignment &sentence)
{
