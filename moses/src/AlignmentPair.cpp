// $Id: AlignmentPair.cpp 552 2009-01-09 14:05:34Z hieu $
/***********************************************************************
...
void AlignmentPair::Append(const AlignmentPair &newAlignment
												, const WordsRange &sourceRange
												, const WordsRange &targetRange)
{
	for (size_t sourcePos = m_sourceAlign.GetSize() ; sourcePos < sourceRange.GetStartPos() ; ++sourcePos)
	{ // pad sourceAlignm with 0 alignments
		m_sourceAlign.Add(AlignmentElement());
	}
