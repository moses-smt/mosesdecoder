...
protected:
	...
	void AddChartLabelDirect(size_t startPos, size_t endPos, const Word &sourceNonTerm);
	void AddChartLabelOverlap(size_t startPos, size_t endPos, const Word &sourceNonTerm);
