// $Id: TypeDef.h 2490 2009-08-11 19:19:54Z hieuhoang1972 $
...
const size_t DEFAULT_MAX_DERIVATION = 200;
const float	 DEFAULT_RULE_COUNT_THRESHOLD = 20;
...
const size_t ARRAY_SIZE_INCR					= 1; //amount by which a phrase gets resized when necessary
