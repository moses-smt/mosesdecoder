// $Id: PhraseDictionaryNewFormat.cpp 2521 2009-08-20 10:30:21Z hieuhoang1972 $
// vim:tabstop=2
...
namespace Moses
{
																				 ...
																				 , float weightWP)
	{
		...
		while(getline(inStream, line))
		{
			...
			targetPhrase->SetDebugOutput(m_filePath + " " + targetPhrase->ToString());
																																							...
																																							, list<pair<size_t,size_t> > &alignmentInfo)
	{
		...
		// source LHS
		const Word &sourceLHS = target.GetSourceLHS();
		currNode = currNode->GetOrCreateChild(sourceLHS, sourceLHS);
