// $Id: TranslationOption.h 1897 2008-10-08 23:51:26Z hieuhoang1972 $
...
protected:
	...
	ScoreComponentCollection	m_lexReordering;
	ScoreComponentCollection	m_maxentReordering;
...
public:
	...
	inline bool IsDeletionOption() const
  {
	...
	/** returns detailed component scores */
	inline const ScoreComponentCollection &GetLexicalReorderingScore() const
	{
		return m_lexReordering;
	}
	
	inline const ScoreComponentCollection &GetMaxentReorderingScore() const
	{
		return m_maxentReordering;
	}

	/** Calculate future score and n-gram score of this trans option, plus the score breakdowns */
	void CalcScore();
	
	void CacheLexicalReorderingProb(const LexicalReordering &lexreordering
													, const Score &score);
													
	void CacheMaxentReorderingProb(const MaxentReordering &maxentreordering
													, const Score &score);
