// $Id: StaticData.h 2510 2009-08-17 17:04:49Z hieuhoang1972 $
...
typedef std::pair<Word, float> UnknownLHSEntry;	
...
protected:	
	...
	std::vector<PhraseDictionary*>	m_unaryPhraseDictionary;
	...
	Word m_inputDefaultNonTerminal, m_outputDefaultNonTerminal, m_glueSourceNonTerminal;
...
public:
	...
	const std::vector<PhraseDictionary*> &GetUnaryPhraseDictionaries() const
	{
		return m_unaryPhraseDictionary;
	}
	...
	const Word &GetGlueSourceNonTerminal() const
	{ return m_glueSourceNonTerminal; }
	...
	bool SentenceOnlyNBest() const
	{ return m_sentenceOnlyNBest; }
};
