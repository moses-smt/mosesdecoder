// $Id: Sentence.cpp 2468 2009-08-06 16:35:23Z hieuhoang1972 $
// vim:tabstop=2
...
, InputType()
{
	...
	m_defaultLabelList.push_back(defaultSourceNonTerm);
	m_defaultLabelList.push_back(glueSourceNonTerminal);
}
