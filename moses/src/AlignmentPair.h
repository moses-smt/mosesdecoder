// $Id: AlignmentPair.h 552 2009-01-09 14:05:34Z hieu $
/***********************************************************************
...
public:
	...
	//! similar to Add(). Make sure there is enough length in source alignment
	void Append(const AlignmentPair &newAlignment, const WordsRange &sourceRange, const WordsRange &targetRange);
