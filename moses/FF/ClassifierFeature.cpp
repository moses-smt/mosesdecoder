...
Translation ClassifierFeature::GetClassifierTranslation(const TranslationOption *option) const
{
...
vector<ScoreComponentCollection> ClassifierFeature::EvaluateOptions(const vector<TranslationOption *> &options, const InputType &src) const
{
