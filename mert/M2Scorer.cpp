...
const char* M2Scorer::code() {
  return
    ...
    "\n"
    "def f1_suffstats(candidate, source, golds_set, max_unchanged_words=2, beta = 1.0, ignore_whitespace_casing= False, verbose=False, very_verbose=False):\n"
    "    stat_correct = 0.0\n"
    "    stat_proposed = 0.0\n"
    "    stat_gold = 0.0\n"
    "\n"
    ...
    "            print \"-------------------------------------------\"\n"
    "    if verbose:\n"
    "        print \">> Chosen Annotator for line:\", chosen_ann\n"
    "        print \"\"\n"
    "    \n"
